        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="text-center md:text-left">
            <h1 className="text-3xl sm:text-4xl mt-4 md:text-5xl lg:text-6xl font-extrabold leading-tight mb-4">
              Latest Electronics <br className="hidden sm:block" /> at Best Prices
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Button className="bg-white text-blue-600 hover:bg-gray-100 px-6 py-2 rounded-xl shadow-lg">
                Shop Now
              </Button>
